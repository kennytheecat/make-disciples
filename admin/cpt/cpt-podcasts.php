...
function cpt_podcasts() {
	...
	$labels = array(
		'name'                  => _x( 'Podcasts', 'Post Type General Name', 'theorthodoxfaith' ),
		'singular_name'         => _x( 'Podcast', 'Post Type Singular Name', 'theorthodoxfaith' ),
		'menu_name'             => __( 'Podcasts', 'theorthodoxfaith' ),
		'name_admin_bar'        => __( 'Podcast', 'theorthodoxfaith' ),
	...
	$args = array(
		'label'                 => __( 'Podcast', 'theorthodoxfaith' ),
		'description'           => __( 'Podcast Description', 'theorthodoxfaith' ),
		'labels'                => $labels,
