...
function cpt_videos() {
	...
	$labels = array(
		'name'                  => _x( 'Videos', 'Post Type General Name', 'theorthodoxfaith' ),
		'singular_name'         => _x( 'Video', 'Post Type Singular Name', 'theorthodoxfaith' ),
		'menu_name'             => __( 'Videos', 'theorthodoxfaith' ),
		'name_admin_bar'        => __( 'Video', 'theorthodoxfaith' ),
	...
	$args = array(
		'label'                 => __( 'Video', 'theorthodoxfaith' ),
		'description'           => __( 'Video Description', 'theorthodoxfaith' ),
		'labels'                => $labels,
